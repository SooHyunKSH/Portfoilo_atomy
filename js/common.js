$(function () {
    ...
    $(".top_btn").on("click", function () {
        ...
        if (!$(".slide_wrap").is(":animated")) {
            $(".slide_container .slide_wrap").animate({
                marginTop: parseInt(slideWrap) + imgNum
            }, 500, "swing", function () {
            ...
            /* text slide */
            $(".slide_txt_container .slide_wrap").animate({
                marginTop: parseInt(txtSlideWrap) + txtNum
            }, 500, "swing");
        }
    })
    ...
    $(".map_tab ul li").mouseover(function () {
        ...
        $(this).each(function () {
            $(".section05 .map").css(
                "background-image",
                "url('./img/worldwide_map0" + thisIndex + ".svg')"
            );
        });
    })

    /* section05 map transition */
    $(".section05 .map_tab ul li:nth-of-type(1)").addClass("click");
